...
public class PhoneBooks {
    ...
    static class PhoneBooksFIOCompare implements Comparator<PhoneBooks> {
        public int compare(PhoneBooks a, PhoneBooks b) {
            return a.getF_I_O().compareTo(b.getF_I_O());
        }

    }

    static class PhoneBooksAdressCompare implements Comparator<PhoneBooks> {
        public int compare(PhoneBooks a, PhoneBooks b) {
    ...
    static class PhoneBooksPhoneCompare implements Comparator<PhoneBooks> {
        public int compare(PhoneBooks a, PhoneBooks b) {
            if (a.getPhones().length > b.getPhones().length)
                return 1;
            else if (a.getPhones().length < b.getPhones().length)
                return -1;
            else
                return 0;
        }
